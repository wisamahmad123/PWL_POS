...
@else
    <form action="{{ url('/profile/' . $password->user_id . '/update_password') }}" method="POST" id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <small id="error-confirm_password" class="error-text form-text text-danger"></small>
                    </div>
                </div>
