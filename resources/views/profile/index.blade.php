...
@section('content')
    <div class="container mt-4">
        ...
        @if (Auth::user()->profile_picture)
            <img src="{{ asset('storage/profile_pictures/' . Auth::user()->profile_picture) }}" alt="Foto Profil" width="150" height="150">
        @else
                ...
                <table id="table-profile" class="table table-bordered table-striped table-hover table-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>********</td>
                            <td>
                                <button onclick="modalAction('{{ url('/profile/' . Auth::user()->user_id . '/change_profile') }}')" class="btn btn-warning btn-sm">Change Profile</button>
                                <button onclick="modalAction('{{ url('/profile/' . Auth::user()->user_id . '/change_password') }}')" class="btn btn-danger btn-sm">Change Password</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
