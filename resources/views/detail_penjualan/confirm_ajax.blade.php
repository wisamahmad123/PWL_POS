...
@else
    <form action="{{ url('/penjualan/' . $dPenjualan->penjualan_id . '/detail/' . $dPenjualan->detail_id . '/delete_ajax') }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="col-9">{{ $dPenjualan->penjualan->penjualan_id }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Nama Barang :</th>
                            <td class="col-9">{{ $dPenjualan->barang->barang_nama }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Harga :</th>
                            <td class="col-9">{{ $dPenjualan->harga }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Jumlah :</th>
                            <td class="col-9">{{ $dPenjualan->jumlah }}</td>
                        </tr>
                    </table>
                </div>
